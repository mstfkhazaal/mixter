    ...
    <div class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900">
        ...
        <div class="hidden w-full place-items-center lg:grid">
            <div class="w-full max-w-lg p-6">
                <img class="w-full" v-if="isDarkModeEnabled" src="images/illustrations/dashboard-check.svg"
                    alt="image" />
            ...
            <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
                ...
                <form class="mt-16" @submit.prevent="submit">
                    <div>
                        <label class="relative flex">
                            <input
                                ...
                                peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                                placeholder="Username or email" type="email" name="email" required autofocus
                                v-model="form.email" />
                            <span
                    ...
                    <div class="flex space-x-4">
                        ...
                        <Link type="button" :href="route('password.request')"
                            class="btn w-full space-x-3 border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
